...
IF ( Cy .gt. 0 ) THEN
   ...
   ENDIF
   CALL neumann_reconstruct(planfc,C1,3,1)
   CALL neumann_reconstruct(planfc,C1,4,1)
ELSE
...
ENDIF
CALL neumann_reconstruct(planfc,C1,5,1)
CALL neumann_reconstruct(planfc,C1,6,1)

! -------------------------------------------
! Print reconstruction errors in real space
! -------------------------------------------
IF ( Cy .gt. 0 ) THEN
   C4 = C1
